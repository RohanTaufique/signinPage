...
const ResetPassword = (props) => {
    const [resetId, setResetId] = useState(props.match.params.resetId);
    ...
    const handleSubmit = e => {
        ...
        { setErrorMessage("Password must contain minimum eight characters, at least one letter and one number.(no special characters are allowed)")
          setErrorIn("password") }
    ...
    return (<>
    <TopBar link={"Signin"} name={"LOGIN"}></TopBar>
